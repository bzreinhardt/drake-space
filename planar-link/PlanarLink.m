classdef PlanarLink < PlanarRigidBodyManipulator
    %Heavily taken from dake examples PlanarLink
    
    properties
    end
  
  methods
    function model = PlanarLink(N) 
...
if nargin < 1
    ...
    function control_region = genControlRegion(obj,x0)
        control_region = LinkControlRegion(x0,obj);
    end
