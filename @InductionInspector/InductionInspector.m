classdef InductionInspector < NonlinRigidBodyManipulator
  ...
  methods
   ...
   %     obj = addContactShapeToBody(obj,'world',plate);
    ...
    function obj = addSphere(obj,rad,varargin)
      ...
      %   orientation of the geometry in the body-frame
        if nargin == 2
            varargin = {[eye(3), [0; 0; -rad];zeros(1,3) 1]};
        end
        sphere = RigidBodySphere(rad,varargin{:});
        sphere.c = [150,150,150]/255;
        obj = addShapeToBody(obj,'world',sphere);
        obj = compile(obj);
    end
